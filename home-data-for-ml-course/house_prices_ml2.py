# -*- coding: utf-8 -*-
"""House_Prices_ML2.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1nUwqCgcnDVxharBRJIAs7Elpz2CSskyV
"""
...
#first_file = uploaded[next(iter(uploaded))]
#train = pd.read_csv(io.BytesIO(first_file))

#uploaded = files.upload()
#first_file = uploaded[next(iter(uploaded))]
#test = pd.read_csv(io.BytesIO(first_file))

train_df = pd.read_csv('./drive/My Drive/kaggle/input/home-data-for-ml-course/train.csv', header=0)
test_df = pd.read_csv('./drive/My Drive/kaggle/input/home-data-for-ml-course/test.csv', header=0)
...
cf.to_excel('./drive/My Drive/kaggle/input/home-data-for-ml-course/cross_frame.xls')
df.to_excel('./drive/My Drive/kaggle/input/home-data-for-ml-course/data_frame.xls')
...
cf.to_excel('./drive/My Drive/kaggle/input/home-data-for-ml-course/cross_frame.xlsx')
df.to_excel('./drive/My Drive/kaggle/input/home-data-for-ml-course/data_frame.xlsx')
df_onehot.to_excel('./drive/My Drive/kaggle/input/home-data-for-ml-course/data_frame_onehot.xlsx')
...
if False: # scikit-learn Random Forest  
    ...
    output.to_csv('./drive/My Drive/kaggle/input/home-data-for-ml-course/output/submission_sklearn_rf.csv', index=False)

# public score 17129.90263
...
if False: # Normal equation
    ...
    output.to_csv('./drive/My Drive/kaggle/input/home-data-for-ml-course/output/submission_normal.csv', index=False)
...
#    print(grid_search.grid_scores_)
    ...
    output.to_csv('./drive/My Drive/kaggle/input/home-data-for-ml-course/output/submission_xgboost.csv', index=False)
...
pickle.dump(regr, open('./drive/My Drive/kaggle/input/home-data-for-ml-course/regr.pkl', 'wb'))
pickle.dump(regr_test, open('./drive/My Drive/kaggle/input/home-data-for-ml-course/regr_test.pkl', 'wb'))
pickle.dump(X, open('./drive/My Drive/kaggle/input/home-data-for-ml-course/X.pkl', 'wb'))
pickle.dump(y, open('./drive/My Drive/kaggle/input/home-data-for-ml-course/y.pkl', 'wb'))
print(dir())
# some time later...
...
best_alpha = 0.0005
params = {'alpha': np.linspace(0.00001, 0.1, 1000)}  # 10000
regr = Lasso(max_iter=5000) # 50000
grid_search = GridSearchCV(estimator = regr, param_grid=params, n_jobs=-1, cv=10)
grid_search.fit(X, y)"""
pickle.dump(grid_search, open('./drive/My Drive/kaggle/input/home-data-for-ml-course/grid_search_Lasso.pkl', 'wb'))

#best_params = report(grid_search.cv_results_)
#print(grid_search.cv_results_)

regr = Lasso(alpha=best_alpha, max_iter=5000)  # 50000
regr.fit(X, y)
...
output['Id'] = test_df['Id']
output['SalePrice'] = np.exp(regr.predict(Xhat))
output.to_csv('./drive/My Drive/kaggle/input/home-data-for-ml-course/output/submission_lasso.csv', index=False)

output = pd.DataFrame()
output['Id'] = test_df['Id']
output['SalePrice'] = np.exp(0.5*(yhat_xgboost+yhat_lasso))
output.to_csv('./drive/My Drive/kaggle/input/home-data-for-ml-course/output/submission_blend.csv', index=False)
